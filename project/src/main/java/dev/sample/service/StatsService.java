...
public class StatsService {
    ...
    private static final java.util.Set<String> VALID_AGE = new java.util.HashSet<>(java.util.Arrays.asList(
            "20", "25", "30", "35", "40", "45", "50", "55", "60", "65", "70", "75", "80", "85"));

    // 유효한 라이프스테이지 코드
    private static final java.util.Set<String> VALID_LIFESTAGE = new java.util.HashSet<>(java.util.Arrays.asList(
            "UNI", "NEW_JOB", "NEW_WED", "CHILD_BABY",
            "CHILD_TEEN", "CHILD_UNI", "GOLLIFE", "SECLIFE", "RETIR"));

    // ★ 핵심 변경: new StatsDao(ds) 삭제!
    // 스프링이 이미 만들어 둔 StatsDao 빈을 생성자 주입(DI)으로 받습니다.
